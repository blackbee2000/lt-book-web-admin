            ...
            <div v-show="!login" class="login">
                <div class="form">
                    ...
                    <el-form ref="form" :model="form" class="formLogin">
                        <div class="logoUser">
                            <img src="../assets/icons/icon-user-login.png" alt="logo-user-login"/>
                            <p>Have an account ?</p>
                        </div>
                        <el-form-item>
                            <el-input v-model="form.userName" placeholder="Enter User Name"></el-input>
                        </el-form-item>
                        <el-form-item>
                    ...
                    <div class="name">
                        <el-dropdown>
                            <span class="el-dropdown-link">
                                Admintrator <i class="el-icon-arrow-down el-icon--right"></i>
                            </span>
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item>
                                    <el-button class="actionIcon" @click="handleLogout()"><i class="el-icon-error" ></i> Logout</el-button>
                                </el-dropdown-item>
                                <el-dropdown-item>
                                    <el-button class="actionIcon" @click="changePassword()"><i class="el-icon-s-tools" ></i> Change Password</el-button>
                                </el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </div>
